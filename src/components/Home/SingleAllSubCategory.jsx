...
const SingleAllSubCategory = ({ item }) => {
  const {
    name,
    subcategory,
    description,
  ...
  return (
    <div className="">
      <div className="max-w-sm mt-7  bg-white border border-gray-200 shadow-2xl dark:bg-gray-800 dark:border-gray-700 ">
...
export default SingleAllSubCategory;
